...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\bupstream\x18\x03 \x01(\v2\x1d.neurouter.config.v1.UpstreamR\bupstream\"\xb7\x04\n" +
	"\x06Server\x124\n" +
	"\x04http\x18\x01 \x01(\v2 .neurouter.config.v1.Server.HTTPR\x04http\x124\n" +
	"\x04grpc\x18\x02 \x01(\v2 .neurouter.config.v1.Server.GRPCR\x04grpc\x1a\xd5\x02\n" +
	"\x04HTTP\x12\x18\n" +
