...
func (x *Server) GetJwtKey() string {
	if x != nil {
		return x.JwtKey
	}
	return ""
...
type Server_HTTP struct {
	...
	// Enables the gRPC-Web bridge on the HTTP server. Defaults to true when unset.
	GrpcWeb       *bool `protobuf:"varint,5,opt,name=grpc_web,json=grpcWeb,proto3,oneof" json:"grpc_web,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server_HTTP) GetGrpcWeb() bool {
	if x != nil && x.GrpcWeb != nil {
		return *x.GrpcWeb
	}
	return false
}
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\bupstream\x18\x03 \x01(\v2\x1d.neurouter.config.v1.UpstreamR\bupstream\"\xd0\x04\n" +
	"\x06Server\x124\n" +
	"\x04http\x18\x01 \x01(\v2 .neurouter.config.v1.Server.HTTPR\x04http\x124\n" +
	"\x04grpc\x18\x02 \x01(\v2 .neurouter.config.v1.Server.GRPCR\x04grpc\x12\x17\n" +
	"\ajwt_key\x18\x03 \x01(\tR\x06jwtKey\x1a\xd5\x02\n" +
	"\x04HTTP\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x129\n" +
	"\x04cors\x18\x04 \x01(\v2%.neurouter.config.v1.Server.HTTP.CORSR\x04cors\x12\x1e\n" +
	"\bgrpc_web\x18\x05 \x01(\bH\x00R\agrpcWeb\x88\x01\x01\x1a\x81\x01\n" +
	"\x04CORS\x12'\n" +
	"\x0fallowed_origins\x18\x01 \x03(\tR\x0eallowedOrigins\x12'\n" +
	"\x0fallowed_methods\x18\x02 \x03(\tR\x0eallowedMethods\x12'\n" +
	"\x0fallowed_headers\x18\x03 \x03(\tR\x0eallowedHeadersB\v\n" +
	"\t_grpc_web\x1ai\n" +
	"\x04GRPC\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
