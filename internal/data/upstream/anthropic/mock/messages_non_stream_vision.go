...
//go:embed messages_non_stream_vision_request.json
var nonStreamVisionRequest []byte

//go:embed messages_non_stream_vision_response.json
var nonStreamVisionResponse []byte
...
// NonStreamVision covers an image input supplied as inline base64 data and a
// plain text description response with stop reason end_turn.
var NonStreamVision = &Fixture{
	...
	ChatResp: &v1.ChatResp{
		...
		Statistics: &v1.Statistics{
			Usage: &v1.Usage{InputTokens: 70, OutputTokens: 63},
		},
	},
}
