...
func NewNeurouterFactory(tracerProvider trace.TracerProvider, logger *slog.Logger) repository.UpstreamFactory[conf.NeurouterConfig] {
	return func(config *conf.NeurouterConfig) (repository.Repo, error) {
