...
const file_neurouter_v1_chat_proto_rawDesc = "" +
	"\n" +
	"\x17neurouter/v1/chat.proto\x12\fneurouter.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x19neurouter/v1/common.proto\"\xaa\x01\n" +
	"\aMessage\x12\x0e\n" +
	...
	"\x04USER\x10\x01\x12\t\n" +
	"\x05MODEL\x10\x02\x12\b\n" +
	"\x04TOOL\x10\x032\x90\x01\n" +
	"\x04Chat\x12G\n" +
