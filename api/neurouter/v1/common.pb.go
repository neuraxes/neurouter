...
type Tool_Function struct {
	...
	InputJsonSchema string                 `protobuf:"bytes,4,opt,name=input_json_schema,json=inputJsonSchema,proto3" json:"input_json_schema,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Tool_Function) GetInputSchema() *Schema {
	if x != nil {
...
func (x *Tool_Function) GetInputJsonSchema() string {
	if x != nil {
...
const file_neurouter_v1_common_proto_rawDesc = "" +
	...
	"\vTYPE_OBJECT\x10\x06\"\xf1\x01\n" +
	"\x04Tool\x129\n" +
	"\bfunction\x18\x01 \x01(\v2\x1b.neurouter.v1.Tool.FunctionH\x00R\bfunction\x1a\xa5\x01\n" +
	"\bFunction\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x127\n" +
	"\finput_schema\x18\x03 \x01(\v2\x14.neurouter.v1.SchemaR\vinputSchema\x12*\n" +
	"\x11input_json_schema\x18\x04 \x01(\tR\x0finputJsonSchemaB\x06\n" +
	"\x04tool*\xf9\x01\n" +
...
var file_neurouter_v1_common_proto_depIdxs = []int32{
	...
	7,  // 14: neurouter.v1.Tool.Function.input_schema:type_name -> neurouter.v1.Schema
